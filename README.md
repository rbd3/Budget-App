...
- [Check the live demo, mobile version](https://github.com/rbd3/Budget-App/tree/deploy)
- [Check quick demonstration of the app video by clicking the link](https://drive.google.com/file/d/1bZWP-zOgNrHZhOVLwxTGg6XnaoP_uj6w/view?usp=sharing)
...
1. Clone this repository to your desired folder:
   ...
   ```sh
   git clone https://github.com/rbd3/Budget-App.git
...
In near future I am planning to implement the following:
  <p>
    UX improvements: include transitions and/or animations, etc.</p>


## 🤝 Contributions, <a name="contributing"></a>issues, and feature requests are welcome!

Feel free to check the [issues page](https://github.com/rbd3/Budget-App/issues).
...
<br>
[![Star](https://img.shields.io/github/stars/agneta1991/Budget-app-capstone?style=social)](https://github.com/rbd3/Budget-App)
